...
const PerformanceHub = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 my-28 mx-32">
            {/* Card 1 */}
            <div className="relative col-span-2 bg-white rounded-lg shadow-lg overflow-hidden">
                <img
                    src={TennisbatBaner}
                    alt="Tennis"
            ...
            <div className="relative  bg-[#9dc923] rounded-lg p-4 shadow-lg overflow-hidden">
                <div>
                    <h1 className='text-5xl w-10/12 text-white font-semibold py-5'>Performance Precision Sport Essentials</h1>
